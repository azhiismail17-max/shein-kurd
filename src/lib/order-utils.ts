...
/**
 * Orders saved as "free shipping" store the price MINUS the region shipping
 * in the sheet (so accounting reflects true revenue), and carry a
 * [ZERO_SHIP] marker in the note. The UI must add the shipping back to
 * display the original price the customer paid.
 */
