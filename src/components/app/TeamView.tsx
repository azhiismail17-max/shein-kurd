...
export default function TeamView({ role, allOrders = [], currentUser, profileMode = 'kurdistani', onOrderClick }: { role: string, allOrders?: Order[], currentUser: string, profileMode?: ProfileMode, onOrderClick?: (order: Order) => void }) {
