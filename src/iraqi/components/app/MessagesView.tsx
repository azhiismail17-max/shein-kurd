...
export default function MessagesView({ role, allOrders = [], profileMode = 'iraqi' }: { role: string, allOrders?: Order[], profileMode?: 'all' | 'kurdistani' | 'iraqi' }) {
  ...
  const [lastRead, setLastRead] = useState<Record<string, number>>(() => {
    try { return JSON.parse(localStorage.getItem('iraqi_messages_last_read') || '{}'); } catch { return {}; }
  });
