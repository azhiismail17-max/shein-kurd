    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        ...
        <div className="bg-[#6b0f14] text-white rounded-2xl p-3 shadow-lg shadow-[#6b0f14]/20">
          <h4 className="text-[#f3d7d9] text-[10px] uppercase tracking-wider font-semibold mb-1">
            IQD Total
          </h4>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-semibold transition-all ${
                copied ? "bg-red-50 text-red-900" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
