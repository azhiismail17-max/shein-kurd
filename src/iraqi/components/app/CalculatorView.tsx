                        ...
                        >
                          <div className="flex gap-4 items-center pb-4 border-b border-gray-100">
                            <div className="flex-1">
                              <label className="text-[10px] text-gray-500 mb-0.5 uppercase tracking-wider font-semibold block">Retail</label>
                            ...
                            <div className="flex-1">
                              <label className="text-[10px] text-gray-500 mb-0.5 uppercase tracking-wider font-semibold block">Promo</label>
                              <div className="relative flex items-center">
    ...
    <div className="space-y-4">
      ...
      <div className="bg-gray-50 rounded-xl p-3 border border-gray-100 space-y-2 text-[10px] text-gray-500 font-medium">
        <div className="flex justify-between items-center mb-1">
          <label className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider block">Cart Items</label>
          <input 
            type="number"
            value={items || ''}
        ...
        <div className="flex justify-between">
          <span>Actual Promo ({promo} &times; {PROMO_MULTIPLIER})</span>
          <span className="text-gray-900">-${calcResult.adjustedPromo.toFixed(2)}</span>
        </div>
        <div className="flex justify-between">
          <span>Formula</span>
          <span className="font-mono text-gray-400">{retail} - {calcResult.adjustedPromo.toFixed(2)}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        <div className="bg-gray-900 text-white rounded-2xl p-3 shadow-lg shadow-gray-900/20">
          <h4 className="text-gray-400 text-[10px] uppercase tracking-wider font-semibold mb-1">USD Total</h4>
          <div className="text-xl font-bold tracking-tight">
            ${calcResult.totalUsd.toFixed(2)}
          </div>
        </div>
        <div className="bg-[#6b0f14] text-white rounded-2xl p-3 shadow-lg shadow-[#6b0f14]/20">
          <h4 className="text-[#f3d7d9] text-[10px] uppercase tracking-wider font-semibold mb-1">IQD Total</h4>
