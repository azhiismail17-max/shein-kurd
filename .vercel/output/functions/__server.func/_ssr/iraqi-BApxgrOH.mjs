...
const DashboardView = React__default.lazy(() => import("./DashboardView-B3D03VMm.mjs"));
const OrderFormView = React__default.lazy(() => import("./OrderFormView-Dm9iXDsK.mjs"));
const OrderListView = React__default.lazy(() => import("./OrderListView-ETMEQTQX.mjs"));
const OrderDetailModal = React__default.lazy(() => import("./OrderDetailModal-C0KXdIER.mjs"));
const BatchesView = React__default.lazy(() => import("./BatchesView-CUBfQXWl.mjs"));
...
const MessagesView = React__default.lazy(() => import("./MessagesView-BKP7HbTu.mjs"));
const TeamView = React__default.lazy(() => import("./TeamView-Dc_zbxVh.mjs"));
