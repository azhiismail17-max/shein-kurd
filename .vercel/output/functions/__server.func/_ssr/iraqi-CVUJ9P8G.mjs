...
const DashboardView = React__default.lazy(() => import("./DashboardView-C5O9ELQg.mjs"));
const OrderFormView = React__default.lazy(() => import("./OrderFormView-LrOEoh8U.mjs"));
const OrderListView = React__default.lazy(() => import("./OrderListView-1SOOhpEw.mjs"));
const OrderDetailModal = React__default.lazy(() => import("./OrderDetailModal-BNn7gT6t.mjs"));
const BatchesView = React__default.lazy(() => import("./BatchesView-B0jaWhQL.mjs"));
...
const MessagesView = React__default.lazy(() => import("./MessagesView-ONXoVhgp.mjs"));
const TeamView = React__default.lazy(() => import("./TeamView-CfdoeaZh.mjs"));
