...
import { getDisplayPrice } from "./order-utils-BT6DDCZZ.mjs";
...
const DashboardView = React__default.lazy(() => import("./DashboardView-VKlCjyTj.mjs"));
const OrderFormView = React__default.lazy(() => import("./OrderFormView-UhtT6F68.mjs"));
const OrderListView = React__default.lazy(() => import("./OrderListView-Dj2mktCr.mjs"));
const OrderDetailModal = React__default.lazy(() => import("./OrderDetailModal-BghCAJxF.mjs"));
const BatchesView = React__default.lazy(() => import("./BatchesView-CkAtOJkp.mjs"));
...
const MessagesView = React__default.lazy(() => import("./MessagesView-C3VyliPO.mjs"));
