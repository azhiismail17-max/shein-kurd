...
import { m as getVerifiedSet, i as getMissingSet, j as getOrderStatus, a as STATUS_COLORS, S as SCRIPT_URL, h as getMissingImages, s as saveMissingImages, t as saveMissingSet, u as saveVerifiedSet } from "./use-toast-CUyDYyz5.mjs";
import { t as toPng } from "../_libs/html-to-image.mjs";
import { e as getLinkedOrdersInfo, g as getBoxName, f as fetchWithRetry, c as cleanOrderNo, h as isOrderFree, b as getDisplayPrice } from "./iraqi-BApxgrOH.mjs";
import OrderFormView from "./OrderFormView-Dm9iXDsK.mjs";
...
const OrderDetailModal = ({ order, onClose, onEdit, onDelete, allOrders, onSuccess, onStatusChange, onMissingClick, onUpdateOrder }) => {
  ...
  const handleWarningImageChange = async (e) => {
    ...
    try {
      const { uploadToImgBB } = await import("./order-utils-BT6DDCZZ.mjs");
      ...
      const { sendNotification } = await import("./notifications-DZXkXpOb.mjs").then((n) => n.n);
  ...
  const handlePdf = async () => {
    ...
    try {
      const { generateSingleOrderPdf } = await import("./pdf-DpcVVNSk.mjs");
