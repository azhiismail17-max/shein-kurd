...
const $$splitComponentImporter$2 = () => import("./iraqi-CVUJ9P8G.mjs").then((n) => n.i);
...
const $$splitComponentImporter$1 = () => import("../_-g847Maba.mjs");
const Route$1 = createFileRoute("/$")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-g847Maba.mjs");
