...
const appCss = "/assets/styles-C0Xt1pVa.css";
...
const $$splitComponentImporter$2 = () => import("./iraqi-BApxgrOH.mjs").then((n) => n.i);
const Route$2 = createFileRoute("/iraqi")({
  ssr: false,
  head: () => ({
    meta: [{
      title: "Shein Iraqi"
      ...
      name: "description",
      content: "Shein Iraqi system"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_-CB8rw1Fj.mjs");
const Route$1 = createFileRoute("/$")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CB8rw1Fj.mjs");
const Route = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const IraqiRoute = Route$2.update({
  id: "/iraqi",
  path: "/iraqi",
