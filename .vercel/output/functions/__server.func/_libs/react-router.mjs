...
import { d as requireReact, c as commonjsGlobal } from "./react.mjs";
import { b as requireReactDom } from "./react-dom.mjs";
import { r as requireDist } from "./cookie.mjs";
import { r as requireSetCookie } from "./set-cookie-parser.mjs";
var domExport = {};
var chunkXEJDWL2B = {};
var chunkSRID2YZ2 = {};
var hasRequiredChunkSRID2YZ2;
function requireChunkSRID2YZ2() {
  if (hasRequiredChunkSRID2YZ2) return chunkSRID2YZ2;
  hasRequiredChunkSRID2YZ2 = 1;
  Object.defineProperty(chunkSRID2YZ2, "__esModule", { value: true });
  ...
  function createRouter(init) {
    ...
    function completeNavigation(location2, newState, { flushSync } = {}) {
      let isActionReload = state.actionData != null && state.navigation.formMethod != null && isMutationMethod(state.navigation.formMethod) && state.navigation.state === "loading" && _optionalChain([location2, "access", (_9) => _9.state, "optionalAccess", (_10) => _10._isRedirect]) !== true;
      let actionData;
      ...
      let preventScrollReset = pendingPreventScrollReset === true || state.navigation.formMethod != null && isMutationMethod(state.navigation.formMethod) && _optionalChain([location2, "access", (_11) => _11.state, "optionalAccess", (_12) => _12._isRedirect]) !== true;
    ...
    async function handleLoaders(request, location2, matches, historyAction, scopedContext, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace2, initialHydration, flushSync, pendingActionResult, callSiteDefaultShouldRevalidate) {
    ...
    async function callDataStrategy(request, path, matches, scopedContext, fetcherKey) {
      ...
      if (!isMutationMethod(request.method)) {
        for (let match of matches) {
          if (_optionalChain([results, "access", (_26) => _26[match.route.id], "optionalAccess", (_27) => _27.type]) === "error") {
            break;
          }
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  chunkSRID2YZ2.Action = Action;
  chunkSRID2YZ2.createMemoryHistory = createMemoryHistory;
  chunkSRID2YZ2.createBrowserHistory = createBrowserHistory;
  chunkSRID2YZ2.createHashHistory = createHashHistory;
  chunkSRID2YZ2.invariant = invariant;
  chunkSRID2YZ2.warning = warning;
  chunkSRID2YZ2.createPath = createPath;
  chunkSRID2YZ2.parsePath = parsePath;
  chunkSRID2YZ2.createContext = createContext;
  chunkSRID2YZ2.RouterContextProvider = RouterContextProvider;
  chunkSRID2YZ2.convertRoutesToDataRoutes = convertRoutesToDataRoutes;
  chunkSRID2YZ2.matchRoutes = matchRoutes;
  chunkSRID2YZ2.matchRoutesImpl = matchRoutesImpl;
  chunkSRID2YZ2.generatePath = generatePath;
  chunkSRID2YZ2.matchPath = matchPath;
  chunkSRID2YZ2.stripBasename = stripBasename;
  chunkSRID2YZ2.resolvePath = resolvePath;
  chunkSRID2YZ2.resolveTo = resolveTo;
  chunkSRID2YZ2.joinPaths = joinPaths;
  chunkSRID2YZ2.data = data;
  chunkSRID2YZ2.redirect = redirect;
  chunkSRID2YZ2.redirectDocument = redirectDocument;
  chunkSRID2YZ2.replace = replace;
  chunkSRID2YZ2.ErrorResponseImpl = ErrorResponseImpl;
  chunkSRID2YZ2.isRouteErrorResponse = isRouteErrorResponse;
  chunkSRID2YZ2.parseToInfo = parseToInfo;
  chunkSRID2YZ2.escapeHtml = escapeHtml;
  chunkSRID2YZ2.encode = encode;
  chunkSRID2YZ2.instrumentHandler = instrumentHandler;
  chunkSRID2YZ2.IDLE_NAVIGATION = IDLE_NAVIGATION;
  chunkSRID2YZ2.IDLE_FETCHER = IDLE_FETCHER;
  chunkSRID2YZ2.IDLE_BLOCKER = IDLE_BLOCKER;
  chunkSRID2YZ2.createRouter = createRouter;
  chunkSRID2YZ2.createStaticHandler = createStaticHandler;
  chunkSRID2YZ2.getStaticContextFromError = getStaticContextFromError;
  chunkSRID2YZ2.invalidProtocols = invalidProtocols;
  chunkSRID2YZ2.isDataWithResponseInit = isDataWithResponseInit;
  chunkSRID2YZ2.isResponse = isResponse;
  chunkSRID2YZ2.isRedirectStatusCode = isRedirectStatusCode;
  chunkSRID2YZ2.isRedirectResponse = isRedirectResponse;
  chunkSRID2YZ2.isMutationMethod = isMutationMethod;
  chunkSRID2YZ2.createRequestInit = createRequestInit;
  chunkSRID2YZ2.SingleFetchRedirectSymbol = SingleFetchRedirectSymbol;
  chunkSRID2YZ2.SINGLE_FETCH_REDIRECT_STATUS = SINGLE_FETCH_REDIRECT_STATUS;
  chunkSRID2YZ2.NO_BODY_STATUS_CODES = NO_BODY_STATUS_CODES;
  chunkSRID2YZ2.StreamTransfer = StreamTransfer;
  chunkSRID2YZ2.getTurboStreamSingleFetchDataStrategy = getTurboStreamSingleFetchDataStrategy;
  chunkSRID2YZ2.getSingleFetchDataStrategyImpl = getSingleFetchDataStrategyImpl;
  chunkSRID2YZ2.stripIndexParam = stripIndexParam;
  chunkSRID2YZ2.singleFetchUrl = singleFetchUrl;
  chunkSRID2YZ2.decodeViaTurboStream = decodeViaTurboStream;
  chunkSRID2YZ2.DataRouterContext = DataRouterContext;
  chunkSRID2YZ2.DataRouterStateContext = DataRouterStateContext;
  chunkSRID2YZ2.RSCRouterContext = RSCRouterContext;
  chunkSRID2YZ2.ViewTransitionContext = ViewTransitionContext;
  chunkSRID2YZ2.FetchersContext = FetchersContext;
  chunkSRID2YZ2.AwaitContextProvider = AwaitContextProvider;
  chunkSRID2YZ2.NavigationContext = NavigationContext;
  chunkSRID2YZ2.LocationContext = LocationContext;
  chunkSRID2YZ2.RouteContext = RouteContext;
  chunkSRID2YZ2.ENABLE_DEV_WARNINGS = ENABLE_DEV_WARNINGS;
  chunkSRID2YZ2.warnOnce = warnOnce;
  chunkSRID2YZ2.decodeRedirectErrorDigest = decodeRedirectErrorDigest;
  chunkSRID2YZ2.decodeRouteErrorResponseDigest = decodeRouteErrorResponseDigest;
  chunkSRID2YZ2.useHref = useHref;
  chunkSRID2YZ2.useInRouterContext = useInRouterContext;
  chunkSRID2YZ2.useLocation = useLocation;
  chunkSRID2YZ2.useNavigationType = useNavigationType;
  chunkSRID2YZ2.useMatch = useMatch;
  chunkSRID2YZ2.useNavigate = useNavigate;
  chunkSRID2YZ2.useOutletContext = useOutletContext;
  chunkSRID2YZ2.useOutlet = useOutlet;
  chunkSRID2YZ2.useParams = useParams;
  chunkSRID2YZ2.useResolvedPath = useResolvedPath;
  chunkSRID2YZ2.useRoutes = useRoutes;
  chunkSRID2YZ2.useRouteId = useRouteId;
  chunkSRID2YZ2.useNavigation = useNavigation;
  chunkSRID2YZ2.useRevalidator = useRevalidator;
  chunkSRID2YZ2.useMatches = useMatches;
  chunkSRID2YZ2.useLoaderData = useLoaderData;
  chunkSRID2YZ2.useRouteLoaderData = useRouteLoaderData;
  chunkSRID2YZ2.useActionData = useActionData;
  chunkSRID2YZ2.useRouteError = useRouteError;
  chunkSRID2YZ2.useAsyncValue = useAsyncValue;
  chunkSRID2YZ2.useAsyncError = useAsyncError;
  chunkSRID2YZ2.useBlocker = useBlocker;
  chunkSRID2YZ2.useRoute = useRoute;
  chunkSRID2YZ2.useRouterState = useRouterState;
  chunkSRID2YZ2.RemixErrorBoundary = RemixErrorBoundary;
  chunkSRID2YZ2.createServerRoutes = createServerRoutes;
  chunkSRID2YZ2.createClientRoutesWithHMRRevalidationOptOut = createClientRoutesWithHMRRevalidationOptOut;
  chunkSRID2YZ2.noActionDefinedError = noActionDefinedError;
  chunkSRID2YZ2.createClientRoutes = createClientRoutes;
  chunkSRID2YZ2.shouldHydrateRouteLoader = shouldHydrateRouteLoader;
  chunkSRID2YZ2.URL_LIMIT = URL_LIMIT;
  chunkSRID2YZ2.getPatchRoutesOnNavigationFunction = getPatchRoutesOnNavigationFunction;
  chunkSRID2YZ2.useFogOFWarDiscovery = useFogOFWarDiscovery;
  chunkSRID2YZ2.getManifestPath = getManifestPath;
  chunkSRID2YZ2.FrameworkContext = FrameworkContext;
  chunkSRID2YZ2.usePrefetchBehavior = usePrefetchBehavior;
  chunkSRID2YZ2.CRITICAL_CSS_DATA_ATTRIBUTE = CRITICAL_CSS_DATA_ATTRIBUTE;
  chunkSRID2YZ2.Links = Links;
  chunkSRID2YZ2.PrefetchPageLinks = PrefetchPageLinks;
  chunkSRID2YZ2.Meta = Meta;
  chunkSRID2YZ2.setIsHydrated = setIsHydrated;
  chunkSRID2YZ2.Scripts = Scripts;
  chunkSRID2YZ2.mergeRefs = mergeRefs;
  chunkSRID2YZ2.mapRouteProperties = mapRouteProperties;
  chunkSRID2YZ2.hydrationRouteProperties = hydrationRouteProperties;
  chunkSRID2YZ2.createMemoryRouter = createMemoryRouter;
  chunkSRID2YZ2.RouterProvider = RouterProvider;
  chunkSRID2YZ2.DataRoutes = DataRoutes2;
  chunkSRID2YZ2.MemoryRouter = MemoryRouter;
  chunkSRID2YZ2.Navigate = Navigate;
  chunkSRID2YZ2.Outlet = Outlet;
  chunkSRID2YZ2.Route = Route;
  chunkSRID2YZ2.Router = Router;
  chunkSRID2YZ2.Routes = Routes;
  chunkSRID2YZ2.Await = Await;
  chunkSRID2YZ2.createRoutesFromChildren = createRoutesFromChildren;
  chunkSRID2YZ2.createRoutesFromElements = createRoutesFromElements;
  chunkSRID2YZ2.renderMatches = renderMatches;
  chunkSRID2YZ2.WithComponentProps = WithComponentProps;
  chunkSRID2YZ2.withComponentProps = withComponentProps;
  chunkSRID2YZ2.WithHydrateFallbackProps = WithHydrateFallbackProps;
  chunkSRID2YZ2.withHydrateFallbackProps = withHydrateFallbackProps;
  chunkSRID2YZ2.WithErrorBoundaryProps = WithErrorBoundaryProps;
  chunkSRID2YZ2.withErrorBoundaryProps = withErrorBoundaryProps;
  return chunkSRID2YZ2;
}
var hasRequiredChunkXEJDWL2B;
function requireChunkXEJDWL2B() {
  if (hasRequiredChunkXEJDWL2B) return chunkXEJDWL2B;
  hasRequiredChunkXEJDWL2B = 1;
  Object.defineProperty(chunkXEJDWL2B, "__esModule", { value: true });
  function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
  }
  var _chunkSRID2YZ2js = /* @__PURE__ */ requireChunkSRID2YZ2();
  function getHydrationData({
    ...
    let initialMatches = _chunkSRID2YZ2js.matchRoutes.call(void 0, routes, location2, basename);
    if (initialMatches) {
      for (let match of initialMatches) {
        let routeId = match.route.id;
        let routeInfo = getRouteInfo(routeId);
        if (_chunkSRID2YZ2js.shouldHydrateRouteLoader.call(
          void 0,
          routeId,
  ...
  chunkXEJDWL2B.getHydrationData = getHydrationData;
  chunkXEJDWL2B.RSCRouterGlobalErrorBoundary = RSCRouterGlobalErrorBoundary;
  chunkXEJDWL2B.RSCDefaultRootErrorBoundary = RSCDefaultRootErrorBoundary;
  chunkXEJDWL2B.createRSCRouteModules = createRSCRouteModules;
  chunkXEJDWL2B.populateRSCRouteModules = populateRSCRouteModules;
  return chunkXEJDWL2B;
}
var development = {};
var chunkIBI7OMNB = {};
var hasRequiredChunkIBI7OMNB;
function requireChunkIBI7OMNB() {
  if (hasRequiredChunkIBI7OMNB) return chunkIBI7OMNB;
  hasRequiredChunkIBI7OMNB = 1;
  Object.defineProperty(chunkIBI7OMNB, "__esModule", { value: true });
  function _interopRequireWildcard(obj) {
    if (obj && obj.__esModule) {
      return obj;
    } else {
  ...
  function deserializeErrors(errors) {
    ...
    for (let [key, val] of entries) {
      if (val && val.__type === "RouteErrorResponse") {
        serialized[key] = new _chunkSRID2YZ2js.ErrorResponseImpl(
          val.status,
          val.statusText,
          val.data,
          val.internal === true
  ...
  var Link = React.forwardRef(
    function LinkWithRef({
      ...
      let location2 = _chunkSRID2YZ2js.useLocation.call(void 0);
      let maskedHref = null;
      if (mask) {
        let resolved = _chunkSRID2YZ2js.resolveTo.call(
          void 0,
          mask,
          [],
      ...
      let [shouldPrefetch, prefetchRef, prefetchHandlers] = _chunkSRID2YZ2js.usePrefetchBehavior.call(
        void 0,
        prefetch,
        rest
      );
  ...
  function ScrollRestoration({
    ...
    return /* @__PURE__ */ React.createElement(
      "script",
      {
        ...
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: `(${restoreScroll})(${_chunkSRID2YZ2js.escapeHtml.call(
            void 0,
    ...
    return React.useCallback(
      (event) => {
        if (shouldProcessLinkClick(event, target)) {
          event.preventDefault();
          let replace = replaceProp !== void 0 ? replaceProp : _chunkSRID2YZ2js.createPath.call(void 0, location2) === _chunkSRID2YZ2js.createPath.call(void 0, path);
  ...
  function useFetcher({
    ...
    _chunkSRID2YZ2js.invariant.call(
      void 0,
      routeId != null,
    ...
    if (getKey) {
      if (basename !== "/") {
        key = getKey(
          {
            ...location2,
            pathname: _chunkSRID2YZ2js.stripBasename.call(void 0, location2.pathname, basename) || location2.pathname
          },
          matches
        );
      } else {
  ...
  function createStaticRouter(routes, context, opts = {}) {
    let manifest = {};
    let dataRoutes = _chunkSRID2YZ2js.convertRoutesToDataRoutes.call(
      void 0,
      routes,
  ...
  chunkIBI7OMNB.createSearchParams = createSearchParams;
  chunkIBI7OMNB.createBrowserRouter = createBrowserRouter;
  chunkIBI7OMNB.createHashRouter = createHashRouter;
  chunkIBI7OMNB.BrowserRouter = BrowserRouter;
  chunkIBI7OMNB.HashRouter = HashRouter;
  chunkIBI7OMNB.HistoryRouter = HistoryRouter;
  chunkIBI7OMNB.Link = Link;
  chunkIBI7OMNB.NavLink = NavLink;
  chunkIBI7OMNB.Form = Form;
  chunkIBI7OMNB.ScrollRestoration = ScrollRestoration;
  chunkIBI7OMNB.useLinkClickHandler = useLinkClickHandler;
  chunkIBI7OMNB.useSearchParams = useSearchParams;
  chunkIBI7OMNB.useSubmit = useSubmit;
  chunkIBI7OMNB.useFormAction = useFormAction;
  chunkIBI7OMNB.useFetcher = useFetcher;
  chunkIBI7OMNB.useFetchers = useFetchers;
  chunkIBI7OMNB.useScrollRestoration = useScrollRestoration;
  chunkIBI7OMNB.useBeforeUnload = useBeforeUnload;
  chunkIBI7OMNB.usePrompt = usePrompt;
  chunkIBI7OMNB.useViewTransitionState = useViewTransitionState;
  chunkIBI7OMNB.StaticRouter = StaticRouter;
  chunkIBI7OMNB.StaticRouterProvider = StaticRouterProvider;
  chunkIBI7OMNB.createStaticHandler = createStaticHandler2;
  chunkIBI7OMNB.createStaticRouter = createStaticRouter;
  return chunkIBI7OMNB;
}
...
function requireDevelopment() {
  ...
  var _chunkXEJDWL2Bjs = /* @__PURE__ */ requireChunkXEJDWL2B();
  var _chunkIBI7OMNBjs = /* @__PURE__ */ requireChunkIBI7OMNB();
  var _chunkSRID2YZ2js = /* @__PURE__ */ requireChunkSRID2YZ2();
  var _react = requireReact();
  var React = _interopRequireWildcard(_react);
  var React2 = _interopRequireWildcard(_react);
  ...
  function ServerRouter({
    ...
    let routes = _chunkSRID2YZ2js.createServerRoutes.call(
      void 0,
      manifest.routes,
      routeModules,
      context.future,
    ...
    for (let match of context.staticHandlerContext.matches) {
      ...
      if (route && manifestRoute && _chunkSRID2YZ2js.shouldHydrateRouteLoader.call(
        void 0,
        routeId,
        route.clientLoader,
    ...
    return function RoutesTestStub({
      ...
      if (routerRef.current == null) {
        ...
        let patched = processRoutes(
          ...
          _context !== void 0 ? _context : _optionalChain([future, "optionalAccess", (_5) => _5.v8_middleware]) ? new _chunkSRID2YZ2js.RouterContextProvider() : {},
  ...
  var _cookie = /* @__PURE__ */ requireDist();
  ...
  function warnOnceAboutExpiresCookie(name, expires) {
    _chunkSRID2YZ2js.warnOnce.call(
      void 0,
      !expires,
  ...
  function matchServerRoutes(manifest, dataRoutes, branches, pathname, basename) {
    let matches = _chunkSRID2YZ2js.matchRoutesImpl.call(
      void 0,
      dataRoutes,
      pathname,
      _nullishCoalesce(basename, () => "/"),
      ...
      let commonRoute = {
        ...
        loader: route.module.loader ? async (args) => {
          ...
          if (preRenderedData != null) {
            ...
            let decoded = await _chunkSRID2YZ2js.decodeViaTurboStream.call(void 0, stream, commonjsGlobal);
  ...
  function derive(build, mode) {
    ...
    let requestHandler = async (request, initialContext) => {
      ...
      if (build.future.v8_middleware) {
        ...
        loadContext = initialContext || new _chunkSRID2YZ2js.RouterContextProvider();
      } else {
      ...
      if (!build.ssr) {
        ...
        if (build.basename && build.basename !== "/") {
          ...
          if (strippedPath == null) {
            errorHandler(
              new _chunkSRID2YZ2js.ErrorResponseImpl(
                404,
                "Not Found",
      ...
      let manifestUrl = _chunkSRID2YZ2js.getManifestPath.call(
        void 0,
      ...
      if (requestUrl.pathname.endsWith(".data")) {
        ...
        } else if (mode === "development" && _optionalChain([getDevServerHooks, "call", (_15) => _15(), "optionalAccess", (_16) => _16.getCriticalCss])) {
    ...
    if (build.entry.module.instrumentations) {
      requestHandler = _chunkSRID2YZ2js.instrumentHandler.call(
        void 0,
        requestHandler,
  ...
  async function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
    ...
    async function renderHtml(context, isSpaMode2) {
      ...
      try {
        ...
        context = _chunkSRID2YZ2js.getStaticContextFromError.call(
          void 0,
          staticHandler.dataRoutes,
          context,
...
${String(error)}`;
          ...
          },
          {
            onError(error2) {
              if (typeof error2 === "object" && error2 && "digest" in error2 && typeof error2.digest === "string") {
                ...
                let routeErrorResponse = _chunkSRID2YZ2js.decodeRouteErrorResponseDigest.call(
                  void 0,
                  error2.digest
                );
                if (routeErrorResponse) {
  ...
  function RSCStaticRouter({ getPayload }) {
    ...
    const router = _chunkIBI7OMNBjs.createStaticRouter.call(
      void 0,
  ...
  development.Await = _chunkSRID2YZ2js.Await;
  development.BrowserRouter = _chunkIBI7OMNBjs.BrowserRouter;
  development.Form = _chunkIBI7OMNBjs.Form;
  development.HashRouter = _chunkIBI7OMNBjs.HashRouter;
  development.IDLE_BLOCKER = _chunkSRID2YZ2js.IDLE_BLOCKER;
  development.IDLE_FETCHER = _chunkSRID2YZ2js.IDLE_FETCHER;
  development.IDLE_NAVIGATION = _chunkSRID2YZ2js.IDLE_NAVIGATION;
  development.Link = _chunkIBI7OMNBjs.Link;
  development.Links = _chunkSRID2YZ2js.Links;
  development.MemoryRouter = _chunkSRID2YZ2js.MemoryRouter;
  development.Meta = _chunkSRID2YZ2js.Meta;
  development.NavLink = _chunkIBI7OMNBjs.NavLink;
  development.Navigate = _chunkSRID2YZ2js.Navigate;
  development.NavigationType = _chunkSRID2YZ2js.Action;
  development.Outlet = _chunkSRID2YZ2js.Outlet;
  development.PrefetchPageLinks = _chunkSRID2YZ2js.PrefetchPageLinks;
  development.Route = _chunkSRID2YZ2js.Route;
  development.Router = _chunkSRID2YZ2js.Router;
  development.RouterContextProvider = _chunkSRID2YZ2js.RouterContextProvider;
  development.RouterProvider = _chunkSRID2YZ2js.RouterProvider;
  development.Routes = _chunkSRID2YZ2js.Routes;
  development.Scripts = _chunkSRID2YZ2js.Scripts;
  development.ScrollRestoration = _chunkIBI7OMNBjs.ScrollRestoration;
  development.ServerRouter = ServerRouter;
  development.StaticRouter = _chunkIBI7OMNBjs.StaticRouter;
  development.StaticRouterProvider = _chunkIBI7OMNBjs.StaticRouterProvider;
  development.UNSAFE_AwaitContextProvider = _chunkSRID2YZ2js.AwaitContextProvider;
  development.UNSAFE_DataRouterContext = _chunkSRID2YZ2js.DataRouterContext;
  development.UNSAFE_DataRouterStateContext = _chunkSRID2YZ2js.DataRouterStateContext;
  development.UNSAFE_ErrorResponseImpl = _chunkSRID2YZ2js.ErrorResponseImpl;
  development.UNSAFE_FetchersContext = _chunkSRID2YZ2js.FetchersContext;
  development.UNSAFE_FrameworkContext = _chunkSRID2YZ2js.FrameworkContext;
  development.UNSAFE_LocationContext = _chunkSRID2YZ2js.LocationContext;
  development.UNSAFE_NavigationContext = _chunkSRID2YZ2js.NavigationContext;
  development.UNSAFE_RSCDefaultRootErrorBoundary = _chunkXEJDWL2Bjs.RSCDefaultRootErrorBoundary;
  development.UNSAFE_RemixErrorBoundary = _chunkSRID2YZ2js.RemixErrorBoundary;
  development.UNSAFE_RouteContext = _chunkSRID2YZ2js.RouteContext;
  development.UNSAFE_ServerMode = ServerMode;
  development.UNSAFE_SingleFetchRedirectSymbol = _chunkSRID2YZ2js.SingleFetchRedirectSymbol;
  development.UNSAFE_ViewTransitionContext = _chunkSRID2YZ2js.ViewTransitionContext;
  development.UNSAFE_WithComponentProps = _chunkSRID2YZ2js.WithComponentProps;
  development.UNSAFE_WithErrorBoundaryProps = _chunkSRID2YZ2js.WithErrorBoundaryProps;
  development.UNSAFE_WithHydrateFallbackProps = _chunkSRID2YZ2js.WithHydrateFallbackProps;
  development.UNSAFE_createBrowserHistory = _chunkSRID2YZ2js.createBrowserHistory;
  development.UNSAFE_createClientRoutes = _chunkSRID2YZ2js.createClientRoutes;
  development.UNSAFE_createClientRoutesWithHMRRevalidationOptOut = _chunkSRID2YZ2js.createClientRoutesWithHMRRevalidationOptOut;
  development.UNSAFE_createHashHistory = _chunkSRID2YZ2js.createHashHistory;
  development.UNSAFE_createMemoryHistory = _chunkSRID2YZ2js.createMemoryHistory;
  development.UNSAFE_createRouter = _chunkSRID2YZ2js.createRouter;
  development.UNSAFE_decodeViaTurboStream = _chunkSRID2YZ2js.decodeViaTurboStream;
  development.UNSAFE_deserializeErrors = deserializeErrors;
  development.UNSAFE_getHydrationData = _chunkXEJDWL2Bjs.getHydrationData;
  development.UNSAFE_getPatchRoutesOnNavigationFunction = _chunkSRID2YZ2js.getPatchRoutesOnNavigationFunction;
  development.UNSAFE_getTurboStreamSingleFetchDataStrategy = _chunkSRID2YZ2js.getTurboStreamSingleFetchDataStrategy;
  development.UNSAFE_hydrationRouteProperties = _chunkSRID2YZ2js.hydrationRouteProperties;
  development.UNSAFE_invariant = _chunkSRID2YZ2js.invariant;
  development.UNSAFE_mapRouteProperties = _chunkSRID2YZ2js.mapRouteProperties;
  development.UNSAFE_shouldHydrateRouteLoader = _chunkSRID2YZ2js.shouldHydrateRouteLoader;
  development.UNSAFE_useFogOFWarDiscovery = _chunkSRID2YZ2js.useFogOFWarDiscovery;
  development.UNSAFE_useScrollRestoration = _chunkIBI7OMNBjs.useScrollRestoration;
  development.UNSAFE_withComponentProps = _chunkSRID2YZ2js.withComponentProps;
  development.UNSAFE_withErrorBoundaryProps = _chunkSRID2YZ2js.withErrorBoundaryProps;
  development.UNSAFE_withHydrateFallbackProps = _chunkSRID2YZ2js.withHydrateFallbackProps;
  development.createBrowserRouter = _chunkIBI7OMNBjs.createBrowserRouter;
  development.createContext = _chunkSRID2YZ2js.createContext;
  development.createCookie = createCookie;
  development.createCookieSessionStorage = createCookieSessionStorage;
  development.createHashRouter = _chunkIBI7OMNBjs.createHashRouter;
  development.createMemoryRouter = _chunkSRID2YZ2js.createMemoryRouter;
  development.createMemorySessionStorage = createMemorySessionStorage;
  development.createPath = _chunkSRID2YZ2js.createPath;
  development.createRequestHandler = createRequestHandler;
  development.createRoutesFromChildren = _chunkSRID2YZ2js.createRoutesFromChildren;
  development.createRoutesFromElements = _chunkSRID2YZ2js.createRoutesFromElements;
  development.createRoutesStub = createRoutesStub;
  development.createSearchParams = _chunkIBI7OMNBjs.createSearchParams;
  development.createSession = createSession;
  development.createSessionStorage = createSessionStorage;
  development.createStaticHandler = _chunkIBI7OMNBjs.createStaticHandler;
  development.createStaticRouter = _chunkIBI7OMNBjs.createStaticRouter;
  development.data = _chunkSRID2YZ2js.data;
  development.generatePath = _chunkSRID2YZ2js.generatePath;
  development.href = href;
  development.isCookie = isCookie;
  development.isRouteErrorResponse = _chunkSRID2YZ2js.isRouteErrorResponse;
  development.isSession = isSession;
  development.matchPath = _chunkSRID2YZ2js.matchPath;
  development.matchRoutes = _chunkSRID2YZ2js.matchRoutes;
  development.parsePath = _chunkSRID2YZ2js.parsePath;
  development.redirect = _chunkSRID2YZ2js.redirect;
  development.redirectDocument = _chunkSRID2YZ2js.redirectDocument;
  development.renderMatches = _chunkSRID2YZ2js.renderMatches;
  development.replace = _chunkSRID2YZ2js.replace;
  development.resolvePath = _chunkSRID2YZ2js.resolvePath;
  development.unstable_HistoryRouter = _chunkIBI7OMNBjs.HistoryRouter;
  ...
  development.unstable_usePrompt = _chunkIBI7OMNBjs.usePrompt;
  development.unstable_useRoute = _chunkSRID2YZ2js.useRoute;
  development.unstable_useRouterState = _chunkSRID2YZ2js.useRouterState;
  development.useActionData = _chunkSRID2YZ2js.useActionData;
  development.useAsyncError = _chunkSRID2YZ2js.useAsyncError;
  development.useAsyncValue = _chunkSRID2YZ2js.useAsyncValue;
  development.useBeforeUnload = _chunkIBI7OMNBjs.useBeforeUnload;
  development.useBlocker = _chunkSRID2YZ2js.useBlocker;
  development.useFetcher = _chunkIBI7OMNBjs.useFetcher;
  development.useFetchers = _chunkIBI7OMNBjs.useFetchers;
  development.useFormAction = _chunkIBI7OMNBjs.useFormAction;
  development.useHref = _chunkSRID2YZ2js.useHref;
  development.useInRouterContext = _chunkSRID2YZ2js.useInRouterContext;
  development.useLinkClickHandler = _chunkIBI7OMNBjs.useLinkClickHandler;
  development.useLoaderData = _chunkSRID2YZ2js.useLoaderData;
  development.useLocation = _chunkSRID2YZ2js.useLocation;
  development.useMatch = _chunkSRID2YZ2js.useMatch;
  development.useMatches = _chunkSRID2YZ2js.useMatches;
  development.useNavigate = _chunkSRID2YZ2js.useNavigate;
  development.useNavigation = _chunkSRID2YZ2js.useNavigation;
  development.useNavigationType = _chunkSRID2YZ2js.useNavigationType;
  development.useOutlet = _chunkSRID2YZ2js.useOutlet;
  development.useOutletContext = _chunkSRID2YZ2js.useOutletContext;
  development.useParams = _chunkSRID2YZ2js.useParams;
  development.useResolvedPath = _chunkSRID2YZ2js.useResolvedPath;
  development.useRevalidator = _chunkSRID2YZ2js.useRevalidator;
  development.useRouteError = _chunkSRID2YZ2js.useRouteError;
  development.useRouteLoaderData = _chunkSRID2YZ2js.useRouteLoaderData;
  development.useRoutes = _chunkSRID2YZ2js.useRoutes;
  development.useSearchParams = _chunkIBI7OMNBjs.useSearchParams;
  development.useSubmit = _chunkIBI7OMNBjs.useSubmit;
  development.useViewTransitionState = _chunkIBI7OMNBjs.useViewTransitionState;
  return development;
}
...
function requireDomExport() {
  ...
  function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
    let dataStrategy = _chunkSRID2YZ2js.getSingleFetchDataStrategyImpl.call(
      void 0,
      getRouter,
      (match) => {
        let M = match;
  ...
  function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
    return async (args, basename, trailingSlashAware, targetRoutes) => {
      ...
      if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
        throw new _chunkSRID2YZ2js.ErrorResponseImpl(res.status, res.statusText, await res.text());
      }
  ...
  function createRouteFromServerManifest(match, payload) {
    ...
    if (typeof dataRoute.loader === "function") {
      dataRoute.loader.hydrate = _chunkSRID2YZ2js.shouldHydrateRouteLoader.call(
        void 0,
        match.id,
        match.clientLoader,
        match.hasLoader,
  ...
  function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
    if (!hasHandler) {
      ...
      console.error(msg);
      throw new _chunkSRID2YZ2js.ErrorResponseImpl(400, "Bad Request", new Error(msg), true);
    }
  }
  var nextPaths = /* @__PURE__ */ new Set();
  var discoveredPathsMaxSize = 1e3;
  ...
  domExport.RouterProvider = RouterProvider2;
...
export {
  requireDomExport as a,
  requireDevelopment as r
};
